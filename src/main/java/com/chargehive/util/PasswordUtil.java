...
public class PasswordUtil {
    ...
    public static String encrypt(String username, String password) {
        if (username == null || password == null) {
            logger.warning("Username or password is null during encryption");
            return null;
        }
        ...
        try {
            ...
            if (aesKeyFromPassword == null) {
                logger.severe("Failed to generate AES key during encryption");
                return null;
            }
    ...
    public static String decrypt(String username, String encryptedPassword) {
        if (username == null || encryptedPassword == null) {
            logger.warning("Username or encrypted password is null during decryption");
            return null;
        }
        ...
        try {
            ...
            SecretKey aesKeyFromPassword = getAESKeyFromPassword(username.toCharArray(), salt);
            if (aesKeyFromPassword == null) {
                logger.severe("Failed to generate AES key during decryption");
                return null;
            }
            ...
            logger.log(Level.SEVERE, "Decryption failed for user: " + username, ex);
            return null;
        }
    }
}